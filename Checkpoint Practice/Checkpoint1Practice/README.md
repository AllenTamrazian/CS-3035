<h2><b>Write a C application that creates an array of three instances of a struct that represents a car.  Calculate and print the average miles per gallon of the cars.</b></h2>
<ol>
